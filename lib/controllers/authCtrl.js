...
//API Keys
var tokens = {};
tokens.consumer_key = process.env.TWITTER_CONSUMER_KEY || '71X5pnw5f3j4joC2OIiRXqW6V';
tokens.consumer_secret = process.env.TWITTER_CONSUMER_SECRET || 'yzEEirfGIQshJvsOHp2RP4kRdnQU47gXMHnWPFIHXe2G7vNaaz';
